...
export default function Pipeline() {
    const logos = [
        ...
        { logo: 'dosya.jpg', text: 'Dosya Sunucusu', color: '#FF52C4' },
        { logo: 'botas-logo.png', text: 'ERP', color: '#FF52C4' },
        { logo: 'pipeline.png', text: 'Botaş Pipeline Services', color: '#a70202' },
    ...
    return (
        <>
            <div className='d-flex flex-column align-items-center' style={{ position: 'relative', zIndex: '100', width: '100%' }}>
                <img src='pipeline.png' className='img-fluid' style={{ width: '150px' }} alt='botaş-app'></img>
